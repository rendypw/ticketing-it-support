            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data User /</span> Kelola
                            User Baru</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <form method="POST" enctype="multipart/form-data" action="/simpan-kelola-user/{{ $user->id }}">
                                            {{ csrf_field() }}
                                            <div class="row mb-1">
                                                ...
                                                <div class="col-md-5 pl-1">
                                                    <div class="form-group">
                                                        ...
                                                        <small class="text-muted" style="font-style: italic">
                                                            *kosongkan password jika tidak akan merubahnya</small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
